<%@ Page Language="C#" AutoEventWireup="true"
    ...
    Inherits="WebApplication1.Agent.Dashboard" %>
        ...
        <div class="main-content">
            ...
            <div class="card-row">
                <div class="card">
                    ...
                    <h2><asp:Label ID="lblTotalProperties" runat="server" Text="0" /></h2>
                </div>
                <div class="card approved">
                    <p class="card-title">Approved</p>
                    <h2><asp:Label ID="lblApproved" runat="server" Text="0" /></h2>
                </div>
                ...
                <div class="card booking">
                    ...
                    <h2><asp:Label ID="lblBookings" runat="server" Text="0" /></h2>
                </div>
            </div>

            <!-- Hidden labels for total revenue and commission metrics to preserve UI structure -->
            <asp:Label ID="lblTotalRevenue" runat="server" Visible="false" />
            <asp:Label ID="lblCommission" runat="server" Visible="false" />
